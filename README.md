...
| 	:-----:	 | 	:-----:	 |
| 	Single Item Image Visualization 	| 	First five images from the dataset. 	| 
| 	Single Item Model Accuracy 	| 	Table or Graph (Av. confidence score) demonstrating the overall accuracy of single item detection. 	| 
| 	Single Item Image Accuracy 	| 	Annotated image that demonstrates the success of the model for single item images. 	| 
| 	Multiple Item Original Image vs. Annotation	| 	Example of object detection model accuracy for multiple item images.	| 
